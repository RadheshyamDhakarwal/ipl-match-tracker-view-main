...
const userLogin = (skipInputCheck = false) => {
  ...
  return (
    <div className="max-w-md mx-auto bg-white border rounded-lg shadow-sm p-4">
      ...
      <div className="facebook_login" style={{ display: "flex", justifyContent: "center" }}>
        {!isLoggedIn && (
          <FacebookLogin
